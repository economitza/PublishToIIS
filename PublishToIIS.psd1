@{
    ...
    FunctionsToExport = @('Publish','Get-MSBuild','Get-PublishConfig','Update-PublishToIIS','Protect-ProductionWebConfig','New-DeployInfo','Invoke-DeployOrder','Read-PublishOrder','Write-PublishOrder','Wait-PublishResult','Request-Publish','Get-PublishToIISRepo','Register-PublishTask','New-DeployEndpointToken','Get-DeployEndpointToken','Invoke-DeployEndpointRequest','Start-DeployEndpoint','Request-RemotePublish','Add-DeployQueueItem','Get-DeployQueue','Get-DeployResult','Invoke-DeployQueueDrain')
    CmdletsToExport = @()
    VariablesToExport = @()
